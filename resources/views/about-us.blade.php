    ...
    <div class="section-nav">
        <div class="nav">
            ...
            <div class="contact-us">
                <a href="/contact-us">Contact Us <img src="{{asset('/img/Arrow up-right.png')}}" class="arrowUp"
                        alt=""></a>
            </div>
        </div>
    </div>
    ...
    <div class="whoarewe-section">
        ...
        <div class="section-content">
            <div class="content-desc">
                ...
                <p>IMP, a technology company established in 2014, specializes in tailored technology solutions for our
                    partner businesses.
                    Evolving from a software house, we've grown alongside our clients, focusing on optimization and
                    innovative business solutions.</p>
                <p>Our core values - Professionalism, Creativity, and Solution-oriented - define our culture, creating a
                    comfortable work environment.
                    Committed to service excellence with 24/7 support, we emphasize continuous improvement across our
                    team, delivering relevant and up-to-date solutions.</p>
            </div>
        ...
        <section class="best-team">
            <div class="our-team-section">
                ...
                <nav class="team-nav">
                    ...
                    <a href="#" onclick="divisionShowHide({{ $division->id }})"
            ...
            document.querySelectorAll(".timeline-card").forEach(card => {
                card.addEventListener("click", function () {
                    ...
                    if (this.classList.contains("active")) {
                        img.src =
                            "https://cdn.builder.io/api/v1/image/assets/TEMP/8bceb6f8f4bfc3b29b89aa503e960f447eb5b97fe0963ee3178cc1f991abddc7?placeholderIfAbsent=true&apiKey=cee2b761989b4cd4b33e212a2290fbe6"; // Change to opened image
                    } else {
                        img.src =
                            "https://cdn.builder.io/api/v1/image/assets/TEMP/ff274f990d28a14b5cc8942e4393a964293ad1024bedef694b1542ae5f8442e7?placeholderIfAbsent=true&apiKey=cee2b761989b4cd4b33e212a2290fbe6"; // Revert back
                    }
                });
            });
        });
