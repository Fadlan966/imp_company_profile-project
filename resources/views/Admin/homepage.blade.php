...
<body>
    ...
    <div class="nav-section">
        <nav class="navbar">
            ...
            <a href="/contact-us-admin" class="contact-us">Contact Us <img src="{{ asset('img/Arrow up-right.png') }}" class="arrow-up"/></a>
        </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="hero-text">
        ...
        <a href="/contact-us-admin" class="contact-us" style="color: white">Contact Us <img src="{{ asset('img/Arrow up-right.png') }}" alt="" class="arrow-right" />
        </a>
    </div>
